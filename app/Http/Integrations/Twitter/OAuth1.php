...
class OAuth1
{
    ...
    {
        // $this->config['realm'] = (string) $request->getUri();
     ...
     */
    public function generateNonce(RequestInterface $request): string
    {
     ...
     */
    private function getOauthParams(string $nonce, array $config): array
    {
        $params = [
