...
Der Hauptinput sind die Gespräche, in denen Daniel sein Leben, seine Gedanken,
Erfahrungen und sein Weltmodell untersucht. Alle daraus entstehenden Inhalte
müssen auf diese Gespräche oder auf ausdrückliche Rückmeldungen von Daniel
zurückführbar bleiben. Bereits generierte Inhalte dürfen nicht zu einer
selbstbestätigenden Ersatzquelle werden.

Eine KI gibt den Gedanken zunehmend eine Form, die Daniel vor der
Veröffentlichung nicht selbst kontrolliert.
...
### Webseite und Creator

Auf d15r fließen die verschiedenen Ausdrucksformen zu einer gemeinsamen
öffentlichen Identität zusammen. Der Creator ist die emergierende Person, deren
Webseite d15r mit der Zeit immer stärker wird. Seine kanonische Soul lebt
deshalb in diesem Holon.

Aktuell gibt Daniel die meisten grundlegenden Texte der Webseite selbst vor.
Sie wurden von ihm geschrieben und werden nicht nachträglich als autonome
Werke des Creators ausgegeben. Perspektivisch können eigene Rollen für das
Schreiben, Bearbeiten und Veröffentlichen von Webseitentexten entstehen. Diese
Rollen werden erst eingeführt, wenn die reale Arbeit sie benötigt.

Blogartikel und X-Beiträge entstehen in eigenständigen Holons mit eigenen
Rollen. Diese Rollen dürfen die Soul als gemeinsamen Identitätskontext lesen
und ihre eigenen Prozesse, Tonalitäten und medienspezifischen Konventionen
daraus weiterentwickeln. Erkenntnisse aus ihren Werken fließen als
Beobachtungen zurück; die kanonische Soul wird ausschließlich durch den
Creator verändert.
...
- Die Soul hält fest, was der Creator über seine emergierende Identität gelernt
  hat.
- Medienspezifische Rollen leiten aus der Soul ihre eigene passende
  Arbeitsweise ab.
...
- Generierte Werke werden nicht allein deshalb zur Wahrheit über den Creator,
  weil sie bereits veröffentlicht wurden.
- Die Soul ersetzt weder Daniels Gespräche noch das Weltmodell als fachliche
  Quelle.
