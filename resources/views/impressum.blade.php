    ...
    <section class="border-b border-slate-200 bg-stone-50 dark:border-slate-800 dark:bg-slate-900">
        <div class="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28">
            ...
            <div class="mt-12 grid max-w-3xl gap-8 rounded-2xl border border-slate-200 bg-white p-6 sm:grid-cols-2 sm:p-8 dark:border-slate-700 dark:bg-slate-800/50">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">Angaben gemäß § 5 DDG</p>
        ...
        <div class="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
            <div class="prose prose-slate max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-a:text-sky-700 prose-a:no-underline hover:prose-a:underline prose-hr:border-slate-200 dark:prose-invert dark:prose-a:text-sky-400 dark:prose-hr:border-slate-800">
                ...
                <p>
                    ...
                    <br>
                    Sofern wir Dritte mit der Verarbeitung von Daten auf Grundlage eines sog. „Auftragsverarbeitungsvertrages“ beauftragen, geschieht dies auf Grundlage des Art. 28 DSGVO.</p><h3 id="dsg-general-thirdparty">Übermittlungen in Drittländer</h3><p>Sofern wir Daten in einem Drittland (d.h. außerhalb der Europäischen Union (EU) oder des Europäischen Wirtschaftsraums (EWR)) verarbeiten oder dies im Rahmen der Inanspruchnahme von Diensten Dritter oder Offenlegung, bzw. Übermittlung von Daten an Dritte geschieht, erfolgt dies nur unter den Voraussetzungen der Art. 44 ff. DSGVO. Dies kann insbesondere auf Grundlage eines Angemessenheitsbeschlusses der Europäischen Kommission oder geeigneter Garantien wie den Standardvertragsklauseln erfolgen.</p><h3 id="dsg-general-rightssubject">Rechte der betroffenen Personen</h3><p>Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob betreffende Daten verarbeitet werden und auf Auskunft über diese Daten sowie auf weitere Informationen und Kopie der Daten entsprechend Art. 15 DSGVO.<br>
                    <br>
                ...
                <h3 id="dsg-general-cookies">Cookies und lokale Speicherung</h3>
                <p>
                    Dieses Onlineangebot verwendet eine technisch erforderliche Sitzung. Das zugehörige Cookie dient insbesondere dem Schutz von Formularen vor gefälschten Anfragen, der Verarbeitung des Kontaktformulars und der Anzeige von Rückmeldungen nach dem Absenden. Die Sitzung läuft nach 120 Minuten Inaktivität ab.<br>
                    <br>
                    Wenn Sie den hellen oder dunklen Darstellungsmodus manuell auswählen, wird diese Präferenz im lokalen Speicher Ihres Browsers gespeichert. Sie bleibt dort erhalten, bis Sie die Einstellung ändern oder die Website-Daten in Ihrem Browser löschen.<br>
                    <br>
                    Für diese technisch erforderlichen Speicherungen ist nach § 25 Abs. 2 Nr. 2 TDDDG keine Einwilligung erforderlich. Sie können gespeicherte Cookies und lokale Daten jederzeit über die Einstellungen Ihres Browsers löschen; dadurch können die genannten Funktionen vorübergehend eingeschränkt sein.</p><h3 id="dsg-general-erasure">Löschung von Daten</h3><p>Die von uns verarbeiteten Daten werden nach Maßgabe der Art. 17 und 18 DSGVO gelöscht oder in ihrer Verarbeitung eingeschränkt. Sofern nicht im Rahmen dieser Datenschutzerklärung ausdrücklich angegeben, werden die bei uns gespeicherten Daten gelöscht, sobald sie für ihre Zweckbestimmung nicht mehr erforderlich sind und der Löschung keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Sofern die Daten nicht gelöscht werden, weil sie für andere und gesetzlich zulässige Zwecke erforderlich sind, wird deren Verarbeitung eingeschränkt. D.h. die Daten werden gesperrt und nicht für andere Zwecke verarbeitet. Das gilt z.B. für Daten, die aus handels- oder steuerrechtlichen Gründen aufbewahrt werden müssen.<br>
                    <br>
                ...
                <h3 id="dsg-turnstile">Schutz des Kontaktformulars mit Cloudflare Turnstile</h3>
                <p>
                    Zum Schutz des Kontaktformulars vor automatisierten und missbräuchlichen Anfragen verwenden wir Cloudflare Turnstile, einen Dienst der Cloudflare, Inc. Turnstile wertet hierfür technische Signale aus, insbesondere die IP-Adresse, den TLS-Fingerabdruck, den User-Agent, den Sitekey und die aufgerufene Herkunft. Inhalte Ihrer Nachricht oder andere Formulareingaben werden dabei nach Angaben von Cloudflare nicht verarbeitet.<br>
                    <br>
                    Die Verarbeitung dient ausschließlich der Erkennung und Abwehr von Bots sowie der Sicherheit des Kontaktformulars. Rechtsgrundlage ist unser berechtigtes Interesse an einem sicheren und funktionsfähigen Onlineangebot gemäß Art. 6 Abs. 1 lit. f DSGVO. Soweit Informationen auf Ihrem Endgerät gespeichert oder ausgelesen werden, ist dies für die ausdrücklich gewünschte Nutzung des geschützten Kontaktformulars unbedingt erforderlich (§ 25 Abs. 2 Nr. 2 TDDDG).<br>
                    <br>
                    Cloudflare verarbeitet die Signale zur Bereitstellung des Dienstes in unserem Auftrag und kann sie in eigener Verantwortung zur Verbesserung der Bot-Erkennung verwenden. Weitere Informationen finden Sie im <a href="https://www.cloudflare.com/turnstile-privacy-policy/" rel="noopener noreferrer" target="_blank">Turnstile Privacy Addendum von Cloudflare</a>.
                </p>

                <h3 id="dsg-hostingprovider">Hosting</h3><p></p><p><span class="ts-muster-content">Die von uns in Anspruch genommenen Hosting-Leistungen dienen der Zurverfügungstellung der folgenden Leistungen: Infrastruktur- und Plattformdienstleistungen, Rechenkapazität, Speicherplatz und Datenbankdienste, Sicherheitsleistungen sowie technische Wartungsleistungen, die wir zum Zwecke des Betriebs dieses Onlineangebotes einsetzen. <br>
                        <br>
